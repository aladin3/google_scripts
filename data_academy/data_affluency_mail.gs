/*Sends emails from the current spreadsheet.*/

function sendEmails() {
  var sheet = SpreadsheetApp.getActiveSheet();
  var startRow = 1; 
  var numRows = 5; // change according to how many people should receive email
  ...
  for (i in data) {
    ...
    var subject = 'Data Barometer: How are we doing?'; //writing the actual email
